...
use crate::{
    ...
    stacked::vanilla::{
        challenges::{Challenges, SynthPoRep},
        column::Column,
        create_label,
            ...
            Challenges::Orig(orig_challenges) => {
                ...
                (0..partition_count)
                    .map(|k| {
                        ...
                        let challenge_positions = orig_challenges.derive(
                            graph.size(),
            ...
            Challenges::Synth(synth_challenges) => {
                ...
                if pub_inputs.seed.is_none() {
                    ...
                    let challenge_positions =
                        SynthPoRep::derive_synthetic(graph.size(), &pub_inputs.replica_id, &comm_r);
