...
impl Challenges {
    pub const fn new_original(challenges_per_partition: usize) -> Self {
        Self::Orig(OrigPoRep {
...
mod test {
    ...
    fn test_calculate_fixed_challenges() {
        let layer_challenges = Challenges::new_original(333);
        let expected = 333;
    ...
    fn challenge_partition_equivalence() {
        ...
        for _layer in 1..=layers {
            let one_partition_challenges = OrigPoRep {
