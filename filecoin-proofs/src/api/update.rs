...
/// Encodes a range of data with the given sector key.
///
...
/// starts, i.e. you need to seek to the intended offset before before this function is called. The
/// `nodes_offset` is the node offset relative to the beginning of the file. This information is
/// needed in order to do the decoding correctly. The `nodes_count` is the total number of nodes of
